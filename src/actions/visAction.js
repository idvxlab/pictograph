...
// Exploration
// Mapping
export const encoding = (channel, field, style) => ({
...
export const modifyEncoding = (channel, field, style) => ({
...
//globalColorStyle
export const updateGlobalColorStyle = (colorset) => ({
    type: VisActionType.GLOBAL_STYLE,
    colorset
})
