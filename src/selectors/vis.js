...
// //imageData
// export const imgDataNameList = state => state.vis.imgDataNameList;
// export const imgDataList = state => state.vis.imgDataList;
// export const imgDataIndex = state => state.vis.imgDataIndex;
