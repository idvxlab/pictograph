...
import { Divider ,Icon,Button,Upload,Layout,Radio,message,Modal} from 'antd';
...
export default class DesignPane extends Component {
    ...
    render() {
        ...
        //     // action:'http://10.11.50.52:5000/upload',
        //     // action:'http://127.0.0.1:5000/word2vec',
        //     multiple:false,
        //     //listType: 'picture',
        ...
        //       reqwest({
        //         url: 'http://10.11.50.52:5000/word2vec',//上传url
        //         method: 'post',
        //         processData: false,
        //         data: formData,
        //         success: (res) => {//上传成功回调
