...
const getAverageRows = (rawData, encoding) =>{
    ...
    let data = calculateData.map(function (d,i) {
        d.values.forEach(d=>{
          // console.log('d[encoding.size.field]', d[encoding.size.field])
            sumData[i] += Number(d[encoding.size.field])
            // console.log('sumRows', sumData[i])
...
export {getCategories, getAggregatedRows,getWidth}