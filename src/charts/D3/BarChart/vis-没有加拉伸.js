    ...
    if(props.chartId.indexOf("sugess")<0){       
        ...
        // }
            ...
            for(let i=0;i<colorlen;i++){
                ...
                .attr("class",function(){
                    return "icon-"+pictogram + ' ' + "source-" + encoding.y.field + ' ' + "icontype"+i;
                });
               ...
               for(let a=0;a<colorlen;a++){
                   ...
                   svg.append("g")
                    ...
                    //   .attr("fill",color(categoriescolor[a]))
                      .style("fill",color(categoriescolor[a]))
               }
