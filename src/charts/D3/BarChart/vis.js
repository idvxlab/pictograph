    ...
    if (hasSeries) {
        ...
        if (bartype === "horizontalrect") { //[2]
            ...
            var texts = textpercent.selectAll("text")
                ...
                .attr("y", function (d, i) {
                    return scaley.bandwidth() / 2 + scaley(i) + 7;
                })
        ...
        // }
            ...
            textpercent1.selectAll("text")
                ...
                .attr("text-anchor", "middle")
                .attr("y", function (d, i) {
                    return d3.max(afterIconIndexy) + d3.max(typesizey) + 20;
                })
            ...
            if (colorlen > 5) {
                colorlen = 5;
                categoriescolor = categoriescolor.slice(0, 5)
            }
            ...
            svg.selectAll(".bar")
                ...
                .attr("height", function (d) {
                    return height - y(d[encoding.y.field]);
                })
                .attr("y", function (d) {
