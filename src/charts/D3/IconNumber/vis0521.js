...
if(styletype==="background"){
    ...
    let iconindex=2;
    if(props.chartId.indexOf("sugess")>0) iconindex=2;
    else iconindex=666
    ...
    .append("g")
    .attr("id",function(){   
        if(props.chartId.indexOf("sugess")>0) return `${pictogram}2`
        else return `${pictogram}666`
    })
    .append("path")
    .attr("d",function(){
...
if(styletype==="iconnumber3"){
  ...
  .append("g")
  .attr("id",function(){   
    if(props.chartId.indexOf("sugess")>0) return `${pictogram}1`
    else return `${pictogram}66`
})
  .append("path")
  .attr("d",function(){
      var obj = pictorialtype.find(function (obj) {
      ...
      console.log('obj.picpath',obj.picpath);
      return obj.picpath; 
  })     
